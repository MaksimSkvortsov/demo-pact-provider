...
Pact JSON files are not created or committed here. They come from the consumer repositories:

- `contracts/ts/pacts/` from `demo-pact-consumer-ts`
- `contracts/dotnet/pacts/` from `demo-pact-consumer-dotnet`

The default Pact paths can be overridden with environment variables:
